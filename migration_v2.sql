-- Aura Bistro: Bilingual Schema Migration & Menu Data Import
-- Run this script in the Supabase SQL Editor (https://supabase.com/dashboard/project/_/sql)

-- 1. Drop the table if it exists (This ensures we have the correct columns)
DROP TABLE IF EXISTS menu_items;

-- 2. Create the menu_items table with bilingual columns
...
-- 5. Create admin operations policy
